 ...
 * @author li_ming 
 */
public abstract class AbstractMyBatisConfig implements TransactionManagementConfigurer {
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		Properties properties = new Properties();
		properties.setProperty("mappers", "com.angel.erp.common.mapper.CustomerMapper");
