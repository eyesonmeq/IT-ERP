...
public class ApiPublicController {
	...
	public ModelMap doLogin(@Valid ValidMember validMember, BindingResult bindingResult) {
		...
		example.createCriteria().andEqualTo("account", validMember.getAccount());
		...
		CustomerAuthenticationToken token = new CustomerAuthenticationToken(validMember.getAccount(),
				validMember.getPassword(), false);
